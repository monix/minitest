...
libraryDependencies += "io.monix" %% "minitest" % "2.3.1" % "test"
...
```scala
// use the %%% operator for Scala.js
libraryDependencies += "io.monix" %% "minitest-laws" % "2.3.1" % "test"
```
...
```scala
// use the %%% operator for Scala.js
libraryDependencies += "io.monix" %% "minitest-laws-legacy" % "2.3.1" % "test"
```
